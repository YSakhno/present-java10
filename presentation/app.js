...
app.get('/var', (req, res) => res.render('content/var', {
  white: 'white' in req.query,
  title: config.title + ' - ' + config.varTitle
}));

app.get('/appcds', (req, res) => res.render('content/appcds', {
  white: 'white' in req.query,
  title: config.title + ' - ' + config.appCdsTitle
}));

app.get('/graal', (req, res) => res.render('content/graal', {
  white: 'white' in req.query,
  title: config.title + ' - ' + config.graalTitle
}));
